...
class PigeonFirebase:
    ...
    def pigeonAuth():
        ...
        def firebasePigeonValuesWrote(pigeonEventListener):
            ...
            if (pigeonEventListener.path) == "/mode":
                PigeonDrone.PigeonDrone.pigeon.mode = VehicleMode(pigeonEventListener.data)
            else:
